defmodule CloudNvr.AccountsTest do
  ...
  describe "tenants" do
    alias CloudNvr.Accounts.Tenants
    ...
    test "create_tenants/1 with valid data creates a tenants" do
      assert {:ok, %Tenants{} = tenants} = Accounts.create_tenants(@valid_attrs)
    ...
    test "update_tenants/2 with valid data updates the tenants" do
      tenants = tenants_fixture()
      assert {:ok, %Tenants{} = tenants} = Accounts.update_tenants(tenants, @update_attrs)
    ...
    test "delete_tenants/1 deletes the tenants" do
      tenants = tenants_fixture()
      assert {:ok, %Tenants{}} = Accounts.delete_tenants(tenants)
